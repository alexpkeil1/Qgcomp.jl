...
```@example metals
printbounds(bounds(qcee_fit3))
```
```@example metals
printbounds(bounds(qcboot_fit3))
```
```@example metals
...
```@example metals
printbounds(bounds(qcee_fit3, qcee_fit3.intvals, qcee_fit3.intvals[3]))
```
```@example metals
printbounds(bounds(qcboot_fit3))
```
...
```
```@example metals
responseplot(qc_fit7b, plots=["p", "m"])
```
